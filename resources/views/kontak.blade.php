        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
                ...
                <div class="text-center p-8 rounded-xl scale-in stagger-delay-1" style="background: var(--solar-cream);">
                    <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"
                        style="background: var(--solar-blue);">
                        <i class="fas fa-phone text-2xl text-white"></i>
                    </div>
                    <h3 class="font-display text-xl font-bold mb-3" style="color: var(--solar-blue-dark);">Telepon</h3>
                    <p class="text-gray-700 mb-2">Hubungi kami via telepon</p>
                    <a href="tel:+6281258887895" class="font-semibold hover:underline" style="color: var(--solar-blue);">
                        +62 812-5888-7895
                    </a>
                </div>
                ...
                <div class="text-center p-8 rounded-xl scale-in stagger-delay-2" style="background: var(--solar-cream);">
                    ...
                    <h3 class="font-display text-xl font-bold mb-3" style="color: var(--solar-blue-dark);">WhatsApp</h3>
                    <p class="text-gray-700 mb-2">Chat dengan customer service</p>
                    <a href="https://api.whatsapp.com/send?phone=6281258887895" target="_blank"
                        class="font-semibold hover:underline" style="color: var(--solar-blue);">
                        Chat Sekarang
                    </a>
                </div>
                ...
                <div class="text-center p-8 rounded-xl scale-in stagger-delay-3" style="background: var(--solar-cream);">
                    ...
                    <h3 class="font-display text-xl font-bold mb-3" style="color: var(--solar-blue-dark);">Email</h3>
                    <p class="text-gray-700 mb-2">Kirim email kepada kami</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="fade-in-left">
                    <h2 class="text-3xl font-display font-bold mb-6" style="color: var(--solar-blue-dark);">
                        Kirim Pesan
                    </h2>
                    ...
                    <form action="#" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="nama" name="nama" required
                                class="w-full px-4 py-3 rounded-lg border-2 focus:outline-none focus:border-[var(--solar-blue)] transition"
                                style="border-color: var(--solar-cream);" placeholder="Masukkan nama lengkap Anda">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" required
                                class="w-full px-4 py-3 rounded-lg border-2 focus:outline-none focus:border-[var(--solar-blue)] transition"
                                style="border-color: var(--solar-cream);" placeholder="nama@email.com">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="tel" id="telepon" name="telepon"
                                class="w-full px-4 py-3 rounded-lg border-2 focus:outline-none focus:border-[var(--solar-blue)] transition"
                                style="border-color: var(--solar-cream);" placeholder="+62 812-3456-7890">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="subjek" name="subjek" required
                                class="w-full px-4 py-3 rounded-lg border-2 focus:outline-none focus:border-[var(--solar-blue)] transition"
                                style="border-color: var(--solar-cream);" placeholder="Apa yang bisa kami bantu?">
                        </div>
                ...
                <div class="fade-in-right">
                    <!-- Office Info -->
                    <div class="p-8 rounded-xl mb-8" style="background: var(--solar-cream);">
                        <h3 class="font-display text-2xl font-bold mb-6" style="color: var(--solar-blue-dark);">
                            Kantor Kami
                        </h3>
                        ...
                        <div class="space-y-6">
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h4 class="font-bold mb-1" style="color: var(--solar-blue-dark);">Alamat</h4>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h4 class="font-bold mb-1" style="color: var(--solar-blue-dark);">Jam Operasional</h4>
                                    <p class="text-gray-700">
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h4 class="font-bold mb-1" style="color: var(--solar-blue-dark);">Customer Service</h4>
                                    <p class="text-gray-700">
                    ...
                    <!-- Social Media -->
                    <div class="mt-8 text-center p-6 rounded-xl" style="background: var(--solar-cream);">
                        <h4 class="font-display text-xl font-bold mb-4" style="color: var(--solar-blue-dark);">
                            Ikuti Kami
                        </h4>
            ...
            <div class="mt-20 fade-in">
                ...
                <div class="max-w-4xl mx-auto space-y-4">
                    <div class="p-6 rounded-xl" style="background: var(--solar-cream);">
                        <h4 class="font-bold text-lg mb-2" style="color: var(--solar-blue-dark);">
                            <i class="fas fa-question-circle mr-2" style="color: var(--solar-blue);"></i>
