                ...
                <form action="{{ route('admin.artikels.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
                        ...
                        <input type="text" name="judul" id="judul" value="{{ old('judul') }}" required
                            class="w-full px-3 md:px-4 py-2 md:py-3 text-lg md:text-2xl font-semibold border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--solar-blue)] focus:border-[var(--solar-blue)]"
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" name="gambar_featured" id="gambar_featured" accept="image/*"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[var(--solar-blue)] focus:border-[var(--solar-blue)]">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="meta_description" id="meta_description" rows="3"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[var(--solar-blue)] focus:border-[var(--solar-blue)]">{{ old('meta_description') }}</textarea>
                    </div>
